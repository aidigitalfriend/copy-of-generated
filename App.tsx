...
type RightTab = 'ai' | 'ai-code-review' | 'ai-tools' | 'collab' | 'debug' | 'tasks' | 'package' | 'remote' | 'analytics' | 'techstack' | 'deploy' | 'settings';
...
const App: React.FC = () => {
  ...
  const renderRightIcon = (id: RightTab) => {
    ...
    switch(id) {
      ...
      case 'ai-code-review':
        return <svg className={iconClass} fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>;
      case 'ai-tools':
        ...
        {rightSidebarOpen && (
          <div className={`relative flex flex-col border-l ${panelClasses}`} style={{ width: rightPanelWidth, minWidth: 280, maxWidth: 600 }}>
            ...
            <div className="flex-1 overflow-hidden">
              ...
              {rightTab === 'ai-code-review' && <AICodeReviewPanel />}
